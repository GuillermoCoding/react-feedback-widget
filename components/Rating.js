const Rating = ({ value, maxRating, setRating }) => (
  <div class="flex flex-row">
    {
      Array.from(Array(maxRating), (_, index) => (
        <div class="cursor-pointer" onClick={() => { setRating(index+1) }}>
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill={`${index <= value - 1? "#ffd543" : "gray"}`} viewBox="0 0 24 24">
